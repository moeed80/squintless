...
Squintless is a purpose-built watch face for people who want the time instantly, without decoration getting in the way.
...
When the date matters, tap or shake the watch. Squintless shows a large Russo One month/day date for three seconds, then returns automatically to the default time face.
...
- Feature graphic: `store/feature/squintless-feature-1600x900.png`
