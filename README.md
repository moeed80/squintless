...
The temporary date glance also uses generated Russo One bitmap labels for month and day display. Russo One is kept in `typeface/fonts/russo-one/` under its original SIL Open Font License.
