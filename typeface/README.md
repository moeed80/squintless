...
`fonts/red-hat-display/` contains the Red Hat Display font used for generated store typography. That font is third-party font software under the SIL Open Font License; Squintless source and custom numeral artwork remain MIT licensed.
