...
`fonts/red-hat-display/` contains the Red Hat Display font used for generated store typography and the Red Hat experimental edition. `fonts/russo-one/` contains the Russo One font used for the Russo experimental edition. Both fonts are third-party font software under the SIL Open Font License; Squintless source and custom numeral artwork remain MIT licensed.
