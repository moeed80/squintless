...
`fonts/red-hat-display/` contains the Red Hat Display font used for generated store typography and the Red Hat experimental edition. `fonts/russo-one/` contains the Russo One font used for the Russo experimental edition, the Squintless 1.2 App Store watchface package, and the production date-glance month/day labels. Both fonts are third-party font software under the SIL Open Font License; Squintless source and custom numeral artwork remain MIT licensed.
